<template>
  <form @submit.prevent="handleSubmit" novalidate>
    <h1 class="mb-3 fs-4">Welcome!</h1>
    <p class="mb-3 text-muted">Please create an account to continue.</p>
    <InputField
      label="Name"
      id="name"
      type="text"
    ...
    <div class="d-flex align-items-center mb-3">
      ...
      <span class="mx-3 text-muted">Or sign up using</span>
      <hr class="flex-grow-1" />
    </div>
    ...
    <div class="text-center">
      <span>
        ...
        <router-link class="link-underline-info" to="/login">Login</router-link>
      </span>
    </div>
  </form>
</template>
  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      try {
        ...
        this.$toast.success(`Account successfully created, ${this.name}! You’re all set to log in.`);
